valid_items([]).
valid_items([Head|Tail]) :-
    fd_all_different(Head),
    valid(Tail).

sudoku99(Puzzle, Solution):-
    Solution = Puzzle,
    ...
    valid_items([Row1,Row2,Row3,Row4,Row5,Row6,Row7,Row8,Row9,Col1,Col2,Col3,Col4,Col5,Col6,Col7,Col8,Col9,Square1,Square2,Square3,Square4,Square5,Square6,Square7,Square8,Square9]).
